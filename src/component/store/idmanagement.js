                    ...
                    <ScrollView>
                        <View style={["ls_box"]}>
                            <View style={["bgfff","flexrow","ls_conbox"]}>
                                ...
                                <Text style={["col333","text","fontsize16"]}>张三</Text>
                            </View>
                            <View style={["bgfff","flexrow","ls_conbox"]}>
                                <Text style={["col999","text","fontsize14"]}>账号：</Text>
                                <Text style={["col333","text","fontsize16"]}>1222323242332</Text>
                            </View>
                            <View style={["bgfff","flexrow","ls_conbox"]}>
                                <Text style={["col999","text","fontsize14"]}>最近登陆：</Text>
                                <Text style={["col333","text","fontsize16"]}>04-25 19:00</Text>
                            </View>
                            <View style={["bt_bot","flex1"]}>
                                <Button size={12} style={["but"]} activeStyle={{ backgroundColor: 'red' }}>删除</Button>
                                <Button size={12} style={["but"]} activeStyle={{ backgroundColor: 'red' }}>重置密码</Button>
                            </View>
                        </View>
                    </ScrollView>
                </View>
